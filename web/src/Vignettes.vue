    ...
    <div class="verba-vignettes">
      ...
      <ul class="verba-vignettes">
        <li class="verba-vignettes-item">
          ...
          <div class="vignette-copy">
            ...
            <p>
              ...
              <mark>ultraderecha</mark> en manifestaciones (como la que protestaba por la exhumación de Franco) o altercados (como los de las manifestaciones de Barcelona). También en ese contexto se suele usar "extrema derecha", una expresión más popular, que aparece hasta 13.611 veces desde 2014. Su pico: tras las elecciones andaluzas, cuando se empezó a comentar -por otros partidos y citando declaraciones, no por los propios presentadores del Telediario- el posible pacto PP-Ciudadanos-Vox.
            </p>
          </div>
        ...
        <li class="verba-vignettes-item">
          ...
          <div class="vignette-copy">
            <p>La corrupción es, por desgracia, una constante en los informativos de TVE. La palabra ha aparecido más de 4.000 veces desde 2014 como un goteo constante, aunque algo menos intenso en los últimos años. De hecho, 2.419 veces lo hizo entre 2014 y 2016; y 1.556, ya con menos ritmo, en los tres años siguientes.</p>
            <p>
              El momento álgido se vivió a finales de octubre de 2014, con las detenciones del caso Púnica, que se combinaron con debates parlamentarios y propuestas y pactos en el Congreso para acabar con el problema. Pero la Púnica (353 apariciones) no ha sido la saga corrupta más nombrada. El caso
              <mark
                class="item1"
              >Gürtel</mark> (713) y el de
              <mark class="item2">los ERE</mark> (803) están casi empatados.
            </p>
            <p>
              Durante la última semana de mayo de 2018, justo después de la sentencia de
              <mark
                class="item1"
              >Gürtel</mark>, con la Audiencia Nacional decidiendo si fijaba medidas cautelares para los acusados y la moción de censura contra Mariano Rajoy en marcha, este caso de corrupción fue la estrella de los Telediarios, con el apogeo el día 31, el de la moción que cambió a Rajoy por Sánchez en la presidencia del Gobierno.
            </p>
            <p>
              Para el caso de
              <mark class="item2">los ERE</mark>, esa fecha mágica llegó el 19 de noviembre, con la sentencia que condenó a los expresidentes andaluces Manuel Chaves y José Antonio Griñán, entre otros.
            </p>
            <p></p>
          </div>
          <div class="vignette-methodology">
...
// TODO: again, dupicated CSS due to scoped problems
...
mark {
  ...
  &.item2 {
    background-color: mix($color-highlight-2, white, 85%);
  }
}
