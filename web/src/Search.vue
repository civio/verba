          ...
          <div class="verba-vignettes-intro">
            ...
            <div class="vignettes-carrousel">
              <a href="/vignettes#vignette09">
                <h3 class="vignette-01">¿Pueden las palabras combatir...?</h3>
              </a>
              <a href="/vignettes#vignette07">
                <h2 class="vignette-02">P. Sánchez, el protagonista principal...</h2>
              </a>
              <a href="/vignettes#vignette08">
                <h3 class="vignette-03">Dos días (de 365) sin noticias de...</h3>
              </a>
            </div>
          </div>
